function mechanical2d_batch(eta_sphere,eta_lower_mantle)
...
% boundary conditions
%
bcmode=5; % 1: pure shear 2: no slip 3: free slip 4: periodic in x 5: periodic and top prescribed motion

%==========================================================================
% Physical parameters
%==========================================================================
parameters.Eta           = [1 ;  eta_sphere];                %Viscosity
parameters.Rho         =   [  0;   1];                %Density
parameters.Gy           = [ 0 -1];                %Gravity in y direction
parameters.eta_lower_mantle = eta_lower_mantle;
...
switch bcmode
   case 1
      ...
      % old awy of specifying boundary conditions
      %
   ...
   case 4
    ...
    case 5
        ...
        topfixed = [ find(GCOORD(2,:)==ymax & GCOORD(1,:) > x_left) ];
...
%pname = ['pressure.' num2str(eta_sphere) '.' num2str(eta_lower_mantle) '.eps'];
pname = 'pressure.eps';
print('-depsc','-tiff',pname)
fprintf(1, [num2str(toc,'%8.6f'),'\n']);
fprintf(1, ['\n']);
